...
- You've reported a 4.1.5 regression specific to your environment
  and it hasn't been fixed yet

For everyone else, use **v4.1.5**. Profile files are compatible
...
download these if 4.1.5 doesn't work for you — see [CHANGELOG.md](CHANGELOG.md)
for the comparison.
