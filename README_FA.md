...
- یک regression در 4.1.4 مخصوص محیط خود گزارش داده‌اید و هنوز fix
  نشده است

برای بقیه، از **نسخه 4.1.4** استفاده کنید. فایل‌های پروفایل بین دو
...
فقط در صورتی این‌ها را دانلود کنید که 4.1.4 برای شما کار نمی‌کند —
