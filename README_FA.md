...
- یک regression در 4.1.1 مخصوص محیط خود گزارش داده‌اید و هنوز fix
  نشده است

برای بقیه، از **نسخه 4.1.1** استفاده کنید. فایل‌های پروفایل بین دو
...
فقط در صورتی این‌ها را دانلود کنید که 4.1.1 برای شما کار نمی‌کند —
